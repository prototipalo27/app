  ...
  async function handleDelete(id: string) {
    ...
    if (result.success) {
      setEntries((prev) => {
        ...
        if (removed) {
          setBalance((b) => b - (removed.type === "earned" ? removed.minutes : -removed.minutes));
        }
  ...
  return (
    <div>
      ...
      <div className="mb-4 rounded-lg bg-zinc-50 p-3 dark:bg-zinc-800/50">
        ...
        <p className={`mt-0.5 text-lg font-bold ${balance > 0 ? "text-green-600 dark:text-green-400" : "text-zinc-900 dark:text-white"}`}>
          ...
          <div className="space-y-1.5">
            {entries.map((entry) => (
              ...
              >
                ...
                {isOwnProfile && canDelete(entry.created_at) && (
                  <button
