    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
          ...
          {totalEquity < 100 && (
            <p className="text-xs text-zinc-400">{(100 - totalEquity).toFixed(1)}% sin asignar</p>
          )}
        </div>
        <div className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <div className="flex h-8 overflow-hidden rounded-full">
            ...
            {totalEquity < 100 && (
              ...
              >
                {100 - totalEquity >= 8 ? `Sin asignar ${(100 - totalEquity).toFixed(1)}%` : ""}
              </div>
            )}
          </div>
        </div>
            ...
            {investors.map((investor) => (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-lg font-bold text-zinc-900 dark:text-white">{Number(investor.equity_pct).toFixed(1)}%</p>
    ...
    <form action={onSubmit} className="border-b border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input name="equity_pct" type="number" step="0.1" min="0" max="100" defaultValue={investor?.equity_pct ?? 0} className={inputClass} />
        </div>
        <div>
